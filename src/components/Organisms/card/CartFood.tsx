  ...
  return (
    <div className="w-full bg-[#F9F9F9] hover:bg-[#eeeeee] py-4 px-4 rounded-xl flex flex-col items-center gap-3 mt-5">
      ...
      <h4 className=" w-64 text-center font-semibold py-2 rounded-full bg-[#FFD3F8] font shadow-inner">
        Size {food.size} <span className=" text-red-600">${food.price}</span>{" "}
        only
      </h4>
      <div className=" flex items-center gap-10">
        <button onClick={() => addFoodCart(food)} className=" px-3 py-1 hover:bg-green-400 cursor-pointer bg-green-500 text-white font-semibold rounded-xl">
          Buy
        </button>
